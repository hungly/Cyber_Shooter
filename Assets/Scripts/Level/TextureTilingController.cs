...
{	
	...
	void UpdateTiling ()
	{
		...
		gameObject.renderer.sharedMaterial.mainTextureScale = new Vector2 (planeSizeX * gameObject.transform.lossyScale.x / textureToMeshX, planeSizeZ * gameObject.transform.lossyScale.y / textureToMeshZ);
	}
}